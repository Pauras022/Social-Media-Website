...
export const UserReducer = (state, action) => {
  switch (action.type) {
    ...
    case "SET_FRIENDS_REQUEST_SENT":
      return {
        ...state,
        sentFriendRequests: action.payload,
      };

    case "ADD_FRIENDS_REQUEST_SENT":
      return {
        ...state,
        sentFriendRequests: [action.payload, ...state.sentFriendRequests],
      };
    case "REMOVE_FRIENDS_REQUEST_SENT":
      let rvs_f_filtered = state.sentFriendRequests.filter(
        (r) => r.id !== action.payload
      );
      return {
        ...state,
        sentFriendRequests: rvs_f_filtered,
      };
